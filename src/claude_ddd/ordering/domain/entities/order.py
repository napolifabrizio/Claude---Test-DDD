...
class Order:
    ...
    def add_item(self, product_id: UUID, product_name: str, unit_price: Money, quantity: int) -> None:
        ...
        from claude_ddd.ordering.domain.events.order_events import OrderItemAdded
    ...
    def place(self) -> None:
        ...
        from claude_ddd.ordering.domain.events.order_events import OrderPlaced
        self._events.append(
    ...
    def cancel(self, reason: str = "") -> None:
        ...
        from claude_ddd.ordering.domain.events.order_events import OrderCancelled
