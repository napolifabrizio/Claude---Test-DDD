from claude_ddd.customers.application.dtos.customer_dto import CreateCustomerInput, CustomerOutput
from claude_ddd.customers.domain.entities.customer import Customer
from claude_ddd.customers.domain.repositories.customer_repository import CustomerRepository
