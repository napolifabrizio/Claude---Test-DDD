from claude_ddd.contexts.ordering.application.dtos.order_dto import PlaceOrderInput, OrderItemOutput, OrderOutput
from claude_ddd.contexts.ordering.domain.ports.product_query import IProductQuery
...
class PlaceOrderUseCase:
    ...
    def execute(self, input_data: PlaceOrderInput) -> OrderOutput:
        ...
        for item in order.items:
            self._product_query.reserve_stock(item.product_id, item.quantity)
